...
public class SqlBaseParser extends Parser {
	...
	public static final int
		...
		RULE_selectItem = 7, RULE_relation = 8, RULE_expression = 9, RULE_booleanExpression = 10, 
		RULE_valueExpression = 11, RULE_primaryExpression = 12, RULE_sampledRelation = 13, 
		RULE_aliasedRelation = 14, RULE_relationPrimary = 15, RULE_qualifiedName = 16, 
		RULE_identifier = 17;
	private static String[] makeRuleNames() {
		return new String[] {
			"singleStatement", "statement", "query", "queryNoWith", "queryTerm", 
			"queryPrimary", "querySpecification", "selectItem", "relation", "expression", 
			"booleanExpression", "valueExpression", "primaryExpression", "sampledRelation", 
			"aliasedRelation", "relationPrimary", "qualifiedName", "identifier"
		};
	}
	...
	public final SampledRelationContext sampledRelation() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_sampledRelation);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(81);
	...
	public final AliasedRelationContext aliasedRelation() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_aliasedRelation);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(83);
	...
	public final RelationPrimaryContext relationPrimary() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_relationPrimary);
		try {
