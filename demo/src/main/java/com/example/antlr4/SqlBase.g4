...
statement: query # statementDefault;
...
selectItem: expression # selectSingle;

relation: sampledRelation # relationDefault;

expression: booleanExpression;

booleanExpression: valueExpression # predicated;

valueExpression: primaryExpression # valueExpressionDefault;

primaryExpression: identifier # columnReference;
